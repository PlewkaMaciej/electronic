    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl border border-gray-300">
      ...
      <div className="border p-6 rounded-xl bg-gray-100 flex flex-col items-center">
        <div className="w-24 h-24 sm:w-32 sm:h-32 bg-gray-300 rounded-full overflow-hidden flex items-center justify-center mb-4">
          {selectedFile ? <img src={URL.createObjectURL(selectedFile)} alt="Profile" className="w-full h-full object-cover" /> : <User className="w-12 h-12 sm:w-16 sm:h-16 text-gray-500" />}
        </div>
        ...
        <p className="text-xs text-gray-500 mt-2">JPG, GIF lub PNG. Maksymalny rozmiar pliku: 800 KB.</p>
      </div>
        ...
        {({ isSubmitting }) => (
          <Form>
            ...
            <div className="border p-6 rounded-xl bg-gray-100 mt-6">
              ...
              <Field as="textarea" name="aboutMe" className="w-full p-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" rows={4} placeholder="Napisz kilka słów o sobie..." />
            ...
            <div className="border p-6 rounded-xl bg-gray-100 mt-6">
              ...
              <Field as="select" name="country" className="w-full p-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-1">
              ...
              <label className="block text-sm font-medium text-gray-700 mt-4">Miasto</label>
              <Field type="text" name="city" className="w-full p-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-1" placeholder="Wpisz miasto" />
              <ErrorMessage name="city" component="div" className="text-red-500 text-sm mt-1" />
            </div>
            
            <div className="flex justify-end mt-6">
              <ButtonStyle type="submit" disabled={isSubmitting} className="px-6 py-2">
                Zapisz zmiany
              </ButtonStyle>
            </div>
          </Form>
